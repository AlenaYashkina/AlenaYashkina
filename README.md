...
- **Java Development:** Completed a comprehensive course covering REST API, Spring, Hibernate, GIT and Docker, with a hands-on project.  
...
- **Automation and Optimization:** Developed Python scripts to streamline workflows and reduce manual work.  

## Additional Information  
- **English Proficiency:** Level B2 (Upper Intermediate). Strong verbal and written communication skills.
